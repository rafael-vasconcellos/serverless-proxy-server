...
export default function Logo({ color, size }: LogoProps) {
    return ( 
        <svg class={size ?? "size-64"}
        version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256.000000 256.000000" preserveAspectRatio="xMidYMid meet">
            <g class={color ?? ""} 
            transform="translate(0.000000,256.000000) scale(0.100000,-0.100000)"  stroke="none">
